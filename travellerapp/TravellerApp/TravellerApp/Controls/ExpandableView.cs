namespace Xamarin.Forms.Controls
{
    public class ExpandableView : Frame
    {
        ...
        public static readonly BindableProperty ExpandedProperty = BindableProperty.Create(nameof(Expanded), typeof(bool), typeof(ExpandableView), default(bool), BindingMode.TwoWay, propertyChanged: ExpandedChanged);
