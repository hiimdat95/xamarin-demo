    ...
    public class LocationHelper
    {
        public static async Task<bool> IsGeolocationAvailable()
        {
            if (!await PermissionsHelper.CheckPermissions(Permission.Location))
            {
                ...
                {
                    Application.Current?.MainPage?.DisplayAlert("Location", "Location permission is denied. Please go into Settings and turn on Location for the app.", "OK");
                });
                return false;
            }
            ...
            if (!CrossGeolocator.IsSupported)
            {
                Device.BeginInvokeOnMainThread(() =>
                {
                    Application.Current?.MainPage?.DisplayAlert("Location", "Location is not supported.", "OK");
                });
                return false;
            }
            ...
            if (!CrossGeolocator.Current.IsGeolocationAvailable)
            {
                Device.BeginInvokeOnMainThread(() =>
                {
                    Application.Current?.MainPage?.DisplayAlert("Location", "Location is not available.", "OK");
                });
                return false;
            }
            ...
            if (!CrossGeolocator.Current.IsGeolocationEnabled)
            {
                Device.BeginInvokeOnMainThread(() =>
                {
                    Application.Current?.MainPage?.DisplayAlert("Location", "Location is turn off. Please turn Location on to use the app.", "OK");
                });
                return false;
            }
