	...
	public class BottomBarPageRenderer : VisualElementRenderer<BottomBarPage>, IOnTabClickListener
	{
		...
		protected override void OnElementChanged (ElementChangedEventArgs<BottomBarPage> e)
		{
			...
			if (e.NewElement != null) {
				...
				if (_bottomBar == null) {
					...
					_bottomBar.SetTextAppearance(TravellerApp.Droid.Resource.Style.BottomBarText);
		...
		protected override void OnElementPropertyChanged (object sender, PropertyChangedEventArgs e)
		{
			...
			if (e.PropertyName == nameof (TabbedPage.CurrentPage)) {
				...
				if(_bottomBar !=null)
				{
					//update tabs state when programmatically changing current tab
					var newTabIndex = Element.Children.IndexOf(Element.CurrentPage);
					if(newTabIndex >=0)
						_bottomBar.SelectTabAtPosition(newTabIndex, false);
				}
		...
		void UpdateBarTextColor ()
		{
			...
			_bottomBar.SetActiveTabColor(Element.TabActiveColor.ToAndroid());
