...
{
    internal abstract class AbsListViewScrollDetector : Java.Lang.Object, AbsListView.IOnScrollListener
    {
        public AbsListViewScrollDetector(IntPtr handle, JniHandleOwnership transfer) : base(handle, transfer)
        {
        }

        public AbsListViewScrollDetector() : base()
        {
        }
